...
public class HandTest {
	...
	public void TestStraightFlush() {
		...
		StraightFlush.add(new Card(eSuit.HEARTS,eRank.SIX,0));       //DONE
		StraightFlush.add(new Card(eSuit.HEARTS,eRank.SEVEN,0));
		StraightFlush.add(new Card(eSuit.HEARTS,eRank.EIGHT,0));
		Hand h = new Hand();
		h = makeHand(isStraightFlush,h);
	...
	public void TestFourOfAKind() {	
		...
		FourOfAKind.add(new Card(eSuit.DIAMONDS,eRank.FIVE,0));     //DONE
		FourOfAKind.add(new Card(eSuit.HEARTS,eRank.FIVE,0));
		FourOfAKind.add(new Card(eSuit.DIAMONDS,eRank.SIX,0));
		Hand h = new Hand();
		h = makeHand(isFourOfAKind,h);
	...
	public void TestFlush() {
		...
		Flush.add(new Card(eSuit.CLUBS,eRank.SEVEN,0));   //DONE
	...
	public void TestStraight(){
		...
		Straight.add(new Card(eSuit.DIAMONDS,eRank.SEVEN,0));  //DONE
		Straight.add(new Card(eSuit.HEARTS,eRank.EIGHT,0));
		Straight.add(new Card(eSuit.HEARTS,eRank.NINE,0));
		Hand h = new Hand();
		h = makeHand(isStraight,h);
	...
	public void TestThreeOfAKind(){
		...
		ThreeOfAKind.add(new Card(eSuit.SPADES,eRank.QUEEN,0));
		ThreeOfAKind.add(new Card(eSuit.CLUBS,eRank.QUEEN,0));
		ThreeOfAKind.add(new Card(eSuit.DIAMONDS,eRank.QUEEN,0));	//DONE
		ThreeOfAKind.add(new Card(eSuit.HEARTS,eRank.FIVE,0));
		ThreeOfAKind.add(new Card(eSuit.HEARTS,eRank.ACE,0));
		Hand h = new Hand();
		h = makeHand(isThreeOfAKind,h);
	...
	public void TestTwoPairs(){
		...
		TwoPairs.add(new Card(eSuit.SPADES,eRank.THREE,0));
		TwoPairs.add(new Card(eSuit.CLUBS,eRank.THREE,0));
		TwoPairs.add(new Card(eSuit.DIAMONDS,eRank.SIX,0));		//DONE
		TwoPairs.add(new Card(eSuit.HEARTS,eRank.SIX,0));
		TwoPairs.add(new Card(eSuit.SPADES,eRank.KING,0));
		Hand h = new Hand();
		h = makeHand(isTwoPairs,h);
	...
	public void TestPairs(){
		...
		Pairs.add(new Card(eSuit.DIAMONDS,eRank.SIX,0));		//DONE
		Pairs.add(new Card(eSuit.HEARTS,eRank.JACK,0));
		Pairs.add(new Card(eSuit.SPADES,eRank.ACE,0));
		Hand h = new Hand();
		h = makeHand(isPairs,h);
	...
	public void TestHighCard(){
		...
		HighCard.add(new Card(eSuit.DIAMONDS,eRank.SIX,0));		//DONE
		HighCard.add(new Card(eSuit.HEARTS,eRank.JACK,0));
		HighCard.add(new Card(eSuit.HEARTS,eRank.ACE,0));
		Hand h = new Hand();
		h = makeHand(isHighCard,h);
